...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center p-8 mt-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700">
